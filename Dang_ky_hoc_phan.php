...
<body>
    <div class="sidebar">
        <div class="user-info">
            ...
            <div class="details"><div class="role">Sinh viên</div></div>
        </div>
        <ul>
            ...
            <li class="active"><i class="fas fa-clipboard-list"></i><a href="Dang_ky_hoc_phan.html">Đăng ký học phần</a></li>
            ...
            dangKyHocPhanList
                ...
                .forEach(dk => {
                    ...
                    newRow.innerHTML = `
                        ...
                        <td class="actions">
                            ${isRegistered ?
                                `<button class="cancel-btn" onclick="huyDangKy('${dk.maHP}', '${dk.hocKy}')">Hủy đăng ký</button>` :
                                soLuongDangKy < siSoToiDa ?
                                    `<button class="register-btn" onclick="dangKyHocPhan('${dk.maHP}', '${dk.hocKy}')">Đăng ký</button>` :
                                    `<button class="register-btn" disabled>Hết chỗ</button>`
                            }
                        </td>
                    `;
